...
json_out_path = Path("data/satellite_wildfire_detection/_annotations_cleaned.coco.json")

images_df, annotations_df, categories_df, merged_df = run_pipeline(json_path, json_out_path)