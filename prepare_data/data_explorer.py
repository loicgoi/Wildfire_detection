...
def get_images_per_category(df_annotations: pd.DataFrame, df_category: pd.DataFrame) -> pd.Series:
...
if __name__ == "__main__":
    images_df, annotations_df, categories_df, merged_df = load_annotations_to_df("data/satellite_wildfire_detection/_annotations.coco.json")
